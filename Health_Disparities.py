...
# We assign the raw CSV directly to cms_df so the rest of the script can run.
# Trailing spaces are stripped from the column headers to prevent key errors later.

cms_df = pd.read_csv("/Users/elilicona/Downloads/PortfolioProjects/FY_2026_Hospital_Readmissions_Reduction_Program_Hospital.csv")
